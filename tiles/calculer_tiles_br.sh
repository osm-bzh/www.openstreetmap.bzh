...
# bruz
render_list -a -m br -s /var/run/renderd/renderd.sock -n 3 -t /data/osm/tiles/ -z 16 -x 32445 -X 32453 -y 22777 -Y 22769
render_list -a -m br -s /var/run/renderd/renderd.sock -n 3 -t /data/osm/tiles/ -z 17 -x 64890 -X 64907 -y 45554 -Y 45539
render_list -a -m br -s /var/run/renderd/renderd.sock -n 3 -t /data/osm/tiles/ -z 18 -x 129781 -X 129815 -y 91106 -Y 91078
